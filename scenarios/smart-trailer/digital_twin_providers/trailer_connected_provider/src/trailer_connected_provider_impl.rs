...
//! Module containing gRPC service implementation based on [`core_protobuf_data_access::digital_twin_get_provider.proto`].
//!
//! Provides a gRPC endpoint for getting if the trailer is connected
use smart_trailer_core_protobuf_data_access::digital_twin_get_provider::v1::digital_twin_get_provider_server::DigitalTwinGetProvider;
use smart_trailer_core_protobuf_data_access::digital_twin_get_provider::v1::{GetRequest, GetResponse};
